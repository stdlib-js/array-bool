...
tape( 'attached to the prototype of the main export is a `toReversed` method', function test( t ) {
	t.strictEqual( hasOwnProp( BooleanArray.prototype, 'toReversed' ), true, 'has property' );
	t.strictEqual( isFunction( BooleanArray.prototype.toReversed ), true, 'has method' );
	t.end();
});
